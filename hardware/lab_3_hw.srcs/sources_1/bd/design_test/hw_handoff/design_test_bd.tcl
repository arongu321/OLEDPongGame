...
proc create_root_design { parentCell } {
  ...
  # Create instance: keypad, and set properties
  set keypad [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 keypad ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net keypad_GPIO [get_bd_intf_ports keypad] [get_bd_intf_pins keypad/GPIO]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins keypad/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net processing_system7_0_SPI1_SS1_O [get_bd_pins processing_system7_0/SPI0_SS_I] [get_bd_pins processing_system7_0/SPI1_SS1_O]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins PmodOLED_0/s_axi_aresetn] [get_bd_pins inputs/s_axi_aresetn] [get_bd_pins keypad/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs inputs/S_AXI/Reg] SEG_inputs_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs keypad/S_AXI/Reg] SEG_keypad_Reg
